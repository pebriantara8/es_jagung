...
// Indonesia IT CMS Config 
$config['assets'] = $url_path.'assets/';
$config['admin_dir'] = "admin";
$config['admin_dir_new'] = "admin_new";
$config['admin_email'] = "";
$config['backend_url'] = $config['base_url'].$config['admin_dir_new'].'/';
...
$config['sess_cookie_name'] = 'ci_session_feeltrip';
