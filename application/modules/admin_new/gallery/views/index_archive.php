            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url() ?>public/gallery/thumb/thumb_<?php echo $value['image'] ?>" width="100px"></td>
                  <td><?php echo date('d/m/Y', strtotime($value['created_at'])) ?></td>
                  <td>
                    <a href="<?php echo backend_url().$this->modul ?>/form/<?php echo $value['id'] ?>" class="badge bg-green" title="Edit">Kembalikan</a>
                    <a href="<?php echo backend_url().$this->modul ?>/purge_delete/<?php echo $value['id'] ?>" class="badge bg-red jc_delete_self" title="Edit">Hapus Selamanya</a>
                  </td>
                </tr>
                <?php endforeach ?>
