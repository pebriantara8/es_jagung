            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo backend_url().$this->modul ?>/form/<?php echo $value['id_post'] ?>" class="badge bg-green" title="Edit">Edit</a>
                    <a href="<?php echo backend_url().$this->modul ?>/arsip/<?php echo $value['id_post'] ?>" class="badge bg-red jc_delete_self" title="Edit">Hapus</a>
                  </td>
                </tr>
                <?php endforeach ?>
