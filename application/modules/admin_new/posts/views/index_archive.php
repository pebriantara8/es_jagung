            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo backend_url().$this->modul ?>/form/<?php echo $value['id_post'] ?>/archive" class="badge bg-green" title="Edit">Edit</a>
                    <a href="<?php echo backend_url().$this->modul ?>/publish/<?php echo $value['id_post'] ?>/archive" class="badge bg-red" title="Edit">Publish</a>
                  </td>
                </tr>
                <?php endforeach ?>
