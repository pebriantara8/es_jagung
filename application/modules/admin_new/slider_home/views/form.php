            ...
            <form class="form-horizontal" id="frm_ed_img" action="<?php echo backend_url().$this->modul ?>/<?php echo isset($is_edit) ? 'save_edit' : 'save' ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" placeholder="Judul" value="<?php echo isset($list) ? $list['title'] : '' ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="deskripsi" class="form-control" placeholder="Deskripsi"><?php echo isset($list) ? $list['deskripsi'] : '' ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php if (isset($list)): ?>
                    <img id="file_preview" src="<?php echo base_url() ?>public/slider_home/thumb/thumb_<?php echo htmlspecialchars_decode($list['image']) ?>" alt="" width="150px" />
                    <?php else: ?>
