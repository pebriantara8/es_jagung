        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" title="dashboard" href="<?php echo backend_url() ?>">
                        <!-- Logo icon -->
                        <!-- <b style="top:100px;"><img src="http://sinodegki.org/2016/wp-content/themes/exodus/favicon.ico" alt="logo gki" height="15px" class="dark-logo" /></b> -->
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>Admin</span>
                    </a>
