                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="action-table-link">
                                                        <a href="<?php echo backend_url().$this->modul ?>/form/<?php echo $value['id_post'] ?>" id="edit_post" title="edit">Edit</a> | 
                                                        <a href="<?php echo backend_url().$this->modul ?>/to_draft/<?php echo $value['id_post'] ?>" id="arsip_post" title="simpan ke draft">Draft</a> | 
                                                        <a href="<?php echo backend_url().$this->modul ?>/arsip/<?php echo $value['id_post'] ?>" id="arsip_post" title="arsipkan">Hapus</a>
                                                    </div>
                                                </td>
