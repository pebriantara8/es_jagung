                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="action-table-link">
                                                        <a href="<?php echo backend_url().$this->modul ?>/form/<?php echo $value['id_post'] ?>/draft" id="edit_post" title="edit">Edit</a> | 
                                                        <a href="<?php echo backend_url().$this->modul ?>/publish/<?php echo $value['id_post'] ?>/draft" id="publish_post" title="arsipkan">Publish</a>
                                                    </div>
                                                </td>
