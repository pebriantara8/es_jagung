                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="action-table-link">
                                                        <a href="<?php echo backend_url().$this->modul ?>/form/<?php echo $value['id_post'] ?>/archive" id="edit_post" title="edit">Edit</a> | 
                                                        <a href="<?php echo backend_url().$this->modul ?>/publish/<?php echo $value['id_post'] ?>/archive" id="publish_post" title="arsipkan">Publish</a> | 
                                                        <a href="<?php echo backend_url().$this->modul ?>/delete_forever/<?php echo $value['id_post'] ?>/archive" id="publish_post" title="hapus selamanya">Hapus</a>
                                                    </div>
                                                </td>
                                                <td><?php echo $value['name'] ?></td>
                                                <td><?php echo $value['nama_pelayanan'] ?></td>
                                                <td>
                                                    <?php echo status_post($value['post_status']) ?>
                                                </td>
